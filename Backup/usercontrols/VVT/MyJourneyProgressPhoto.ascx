...
<!--Example assets -->
    <link rel="stylesheet" type="text/css" href="http://sorgalla.com/jcarousel/examples/transitions/jcarousel.transitions.css"> 

    <script type="text/javascript" src="http://sorgalla.com/jcarousel/libs/modernizr/modernizr.js"></script> 
    ...
    <script type="text/javascript" src="http://sorgalla.com/jcarousel/examples/transitions/jcarousel.transitions.js"></script>
