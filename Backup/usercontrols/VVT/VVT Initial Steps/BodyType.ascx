<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BodyType.ascx.cs" Inherits="VisionPersonalTrainingProject.usercontrols.VVT.VVT_Initial_Steps.BodyType" %>
...
<div class="pbodytype" style="margin-right: 10px !important;">
    ...
    <div id="bodytypesummary" style="height: auto;">
        <div style="width:190px; font-weight: bold; font-size: 14px; float:left;">
        ...
        <p>
            <br/>
            <h3><a href="#" class="button-small vision_navy rounded3" id="explannermessage">>> Learn more about your body type <<</a></h3>
        </p>     
    </div>
    ...
    <div style="width: auto; height: 50px;display: none;">
        ...
        <div style="float: right">
             <%--<asp:ImageButton ID="bodyTypeCalculateButton" 
                ...
                &nbsp; &nbsp; &nbsp; &nbsp;--%>
            <asp:imagebutton ID="ImagebuttonNext" ImageUrl="/images/buttonSaveAndNext.gif" ClientIDMode="Static"
    ...
    <div class="istepsWrapper">
        <div style="border-left: none;" onclick="window.open('/club-vision/account-setup/life-style-screen/', '_self');">
            <div><img src="/images/icons/web/prevarrow.png" alt="picture"/></div>
            <div>Prev</div>
        </div>
        <div onclick="skipInitialSteps(3);return false;">
            <div><img src="/images/icons/web/skip.png" alt="picture"/></div>
            <div>Skip</div>
        </div>
        <div id="nextDiv" onclick="$('#ImagebuttonNext').click();return false;">
