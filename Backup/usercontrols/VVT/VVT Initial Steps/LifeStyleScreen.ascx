<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LifeStyleScreen.ascx.cs" Inherits="VisionPersonalTrainingProject.usercontrols.VVT.VVT_Initial_Steps.LifeStyleScreen" %>
...
<div class="plifestylescreen" style="margin-right: 10px !important;margin-bottom: 30px;">
    ...
    <p>
        <asp:CheckBox ID="CheckBox1" runat="server" Text="   I believe that to the best of my knowledge, all of the information I have supplied 
        within this tool is correct" />
    </p>
    <p>
        &nbsp;</p>

        <div style="width: auto; height: 50px;display: none;">
            <div style="float: left">
                <asp:imagebutton ID="backButton" ImageUrl="/images/buttonBack.gif" 
                    runat="server" onclick="BackButtonClick" ></asp:imagebutton>
            </div>
            <div style="float: right">
                <asp:imagebutton ID="saveAndNextButton" ValidationGroup="ls1" ClientIDMode="Static"
...
<div class="istepsDiv">
    <div class="istepsWrapper">
        <div style="border-left: none;" onclick="window.open('/club-vision/account-setup/personal-profile/', '_self');">
            <div><img src="/images/icons/web/prevarrow.png" alt="picture"/></div>
            <div>Prev</div>
        </div>
        <div onclick="skipInitialSteps(2);return false;">
            <div><img src="/images/icons/web/skip.png" alt="picture"/></div>
            <div>Skip</div>
        </div>
        <div id="nextDiv" onclick="$('#saveAndNextButton').click();return false;">
