<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NewTrainingPlan.ascx.cs" Inherits="VisionPersonalTrainingProject.usercontrols.externalclubvision.initialscreens.NewTrainingPlan" %>
...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function () {
      ...
      //  $('.exSelects select').prev().css("width", 135);
       // $('.exSelects select').parent().css("width", 135);
...
<div id="exercisePlannerDiv" class="trainingplan" style="margin-right: 10px !important;">
    <span id="trainingPlanTitle" style="color: #E27423;"><h2>STEP 6</h2></span><br/>
    ...
    <div class="target" style="display: block; width: 583px; float: left; ">
        ...
        <div class="reviewSuggestedPlans" onclick="$('#exercisePlannerDiv').slideToggle('slow', function () { });$('#reviewWorkOutDiv').slideToggle('slow', function () { });return false;" id="divSelectProgram" runat="server" clientidmode="Static" style="margin: 0 auto;vertical-align: middle;height: 30px;width: 296px;display: block;cursor: hand; cursor: pointer;-moz-border-radius: 0px 0px 0px 5px;border-radius: 3px; background-color: #999999;color: white; margin-bottom: 10px;text-align: center;padding-top: 8px;">
        ...
        <div id="divSelectedProgram" runat="server" clientidmode="Static" style="display: none;">
            <table>
                ...
                <tr>
                    <td style="cursor: hand;cursor: pointer;" onclick="" id="reviewProgram" runat="server">
                        Review Your Program
                    </td>
                    <td style="cursor: hand;cursor: pointer;" onclick="clearSelectedProgramAlert();">
                        Clear Selection
                    </td>
                </tr>
            </table>
...
<div id="reviewWorkOutDiv" class="trainingplan" style="margin-right: 10px !important;display: none;">
   <p>We can help you get started with a suggested exercise program that is designed to give you a full body workout that you can do 
    ...
    <div class="selectedProg" style="font-weight: bold;padding-top: 20px;"></div>   
    <br/><br/>
    <a href="#" onclick="$('#DropDownListPrefProg').val('0').change();$('#exercisePlannerDiv').slideToggle('slow', function () { });$('#reviewWorkOutDiv').slideToggle('slow', function () { });return false;">>> Close <<</a>
...
If you find you can do more than the recommended 15 repetitions, simply do more until you reach the correct intensity level.
    ...
    <h3 style="height: 20px !important;color: #e27423;">Select Exercise</h3>
    ...
    <h3 style="height: 20px !important;color: #e27423;">Select Days</h3>
    ...
    <br/><br/>
    <button class="thoughtbot" onclick="buttonFLBeginner();return false;">Save</button>&nbsp;&nbsp;&nbsp;
    <button class="thoughtbot" id="cancelBeginner" onclick="goBackToReviewScreen($(this).attr('id'));return false;">Cancel and Exit</button>&nbsp;&nbsp;&nbsp;
...
If you find you can do more than the recommended 12 repetitions, simply do more until you reach the correct intensity level.
    ...
    <h3 style="height: 20px !important;color: #e27423;">Select Exercises</h3>
    ...
    <br/><br/>
    <button class="thoughtbot" onclick="buttonFLIntermediate();return false;">Save</button>&nbsp;&nbsp;&nbsp;<button class="thoughtbot" id="cancelIntermediate" onclick="goBackToReviewScreen($(this).attr('id'));return false;">Cancel and Exit</button>
...
If you find you can do more than the recommended 12 repetitions, simply do more until you reach the correct intensity level.
    ...
    <br/><br/>
    <h3 style="height: 20px !important;color: #e27423;">Given Exercises</h3>
    ...
    <br/><br/>
    <button class="thoughtbot" onclick="buttonFLAdvance();return false;">Save</button>&nbsp;&nbsp;&nbsp;<button class="thoughtbot" id="cancelAdvance" onclick="goBackToReviewScreen($(this).attr('id'));return false;">Cancel and Exit</button>
