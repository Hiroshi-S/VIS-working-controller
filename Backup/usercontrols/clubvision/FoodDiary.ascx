<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FoodDiary.ascx.cs" Inherits="VisionPersonalTrainingProject.usercontrols.clubvision.FoodDiary" %>
...
<% if (Request.QueryString["tab"] != "week")
   { %>
    <div class="replace" id="foodDiaryTab">
            <div id="tabWeek" style="cursor: pointer; position: absolute; top: 0px; left: 202px; width: 201px; height: 45px" onclick="ReloadCurrentWeek();"></div>
            <div id="tabDay" style="cursor: pointer; position: absolute; top: 0px; left: 0px; width: 201px; height: 45px" onclick="ReloadCurrentDate();"></div>
        </div>
  ...
  <% }
   ...
   { %>
    <div class="replace" id="foodDiaryTab" style="background-image: url(/images/eHdrFoodTabWeek.gif);">
            <div id="tabWeek" style="cursor: pointer; position: absolute; top: 0px; left: 202px; width: 201px; height: 45px" onclick="ReloadCurrentWeek();"></div>
            <div id="tabDay" style="cursor: pointer; position: absolute; top: 0px; left: 0px; width: 201px; height: 45px" onclick="ReloadCurrentDate();"></div>
        </div>
  <div class="eContent eOrange"> 
  <div id="eFoodDiaryTabDay"style="padding-top: 55px; display: block; padding-left: 5px; padding-bottom: 5px;display: none;">
   ...
   <div id="visionLogoTabDay" style="float: left"></div>
      <div style="font-weight: bold; font-size: 14px;float: left; padding-top: 4px; padding-right: 10px">Food Diary for: </div>
    <div style="border: 1px solid #999999; padding: 1px;float: left; height: 21px; width: 274px" class="cal_controls">
<asp:ImageButton runat="server" ID="buttonDayNext" 
        onclick="buttonDayNext_Click" ImageUrl="/images/calendar_forward.gif" style="float: right" />
<asp:ImageButton runat="server" ID="buttonDayPrev" 
        onclick="buttonDayPrev_Click" ImageUrl="/images/calendar_back.gif" style="float: left" />
...
<p style="display: inline-block; padding: 2px 14px"><asp:Literal runat="server" ID="literalDay"></asp:Literal></p>
 ...
 <BDP:BasicDatePicker ID="bdpDay" runat="server" DisplayType="Image" OnSelectionChanged="bdpDay_SelectionChanged"
        AutoPostBack="True" 
...
<div style="float: right; text-align: right; padding-right: 11px; position: relative">
    <% if (Session["MemberType"].Equals("VPT"))
       { %>
       <img src="/images/buttonShare.gif" style="cursor: pointer;" alt="Share" id="imgShare" onclick="var result = toggle_str('shareDailyPlan_Select');hide_one_of();switchto('shareDailyPlan_Select', result);"/>  
    <% }
       else
       {%>
        <img src="/images/sharefacebook.jpg" style="cursor: pointer;" alt="Share" id="img1" onclick="ShareDailyPlanForClient('facebook');"/>  
    <% } %>
    <img src="/images/buttonReset.gif" style="cursor: pointer;" alt="Reset" id="imgreset" />
    <img src="/images/buttonPrint.png" style="cursor: pointer" alt="Print" onclick="popup_and_print()" />  
    <a style="cursor: pointer" onclick="var result = toggle_str('saveAsDailyMenu_Select');hide_one_of();switchto('saveAsDailyMenu_Select', result);"><img src="/images/buttonSaveasDailyMenu.gif" /></a>
    <% if (Session["Trainer"].Equals("No") && Session["MemberType"].Equals("VPT"))
       { %>
    <div style="top: 29px; border: 1px solid #a0a0a0; display: none; position: absolute; width: 186px; height: 92px; padding-top: 6px; padding-left: 12px; background-color: #f1f1f1; font-weight: bold;text-align: left; z-index: 100;" id="shareDailyPlan_Select" class="one_of">
        <p>Share to?</p>
        ...
        <div class="quicktools_option" style="height:25px;text-align:left;vertical-align:middle;" onclick="ShareDailyPlanForClient('trainer')"><img src="/images/trainer.small.icon.jpg"/>&nbsp;&nbsp;&nbsp;My Trainer</div>
    </div>
     <% }
    ...
    <% } %>
<div style="right: 11px; top: 29px; border: 1px solid #a0a0a0; display: none; position: absolute; width: 186px; height: 92px; padding-top: 6px; padding-left: 12px; background-color: #f1f1f1; font-weight: bold;text-align: left; z-index: 10000;" id="saveAsDailyMenu_Select" class="one_of">
    <p>Name this menu</p>
    <input type="text" id="saveAsDailyMenu_Name" style="width: 172px; height: 23px; margin-top: 10px; border: 1px solid #999999" />
    <div style="float: left; cursor: pointer; padding-top: 5px;"  onclick="hide('saveAsDailyMenu_Select');saveAsDailyMeal($('#saveAsDailyMenu_Name').val(),'resultPage');"><img src="/images/buttonSaveMenu.gif" /></div>
    <div style="float: left; cursor: pointer; padding-top: 10px; padding-left: 21px; color: #e27423"  onclick="hide('saveAsDailyMenu_Select');">or Cancel</div>
</div>
...
<a href="/club-vision/my-eating/menus/" style="font-weight: bold" id="viewExisting" >View existing daily menus &gt;</a>
<br />
<br />
...
<tr id="foodDiaryYesOrNo" runat="server" clientidmode="Static">
    <td style="color: #E27423 ;padding-bottom: 10px; font-size: 14px; font-weight: bold; padding-left: 11px;" width="885" colspan="8">
       <div style="float: right">
            <asp:DropDownList ID="PlanCheckDropDownList" runat="server" Width="70" 
                AutoPostBack="False" Visible="True">
                <asp:ListItem runat="server" Value="False">NO</asp:ListItem>
                <asp:ListItem runat="server" Value="True">YES</asp:ListItem>
            </asp:DropDownList>
        </div>
        <div style="float: right;padding-top: 2px;"> <b>Did this plan reflect what you ate this day?</b> &nbsp;&nbsp;&nbsp; </div> 
    </td>
</tr>
<tr id="macro-header">
...
<div style="border-left: 1px solid #cccccc;border-right: 1px solid #cccccc;border-bottom: 1px solid #cccccc; width: 841px; background-color: #ffffff; margin-left: 12px;padding-left: 20px; padding-top: 16px; position: relative;margin-bottom: 10px;padding-bottom: 10px" id="addItemBreakfast_Search_Select">
        ...
        <div style="float:left;">
            <input type="text" id="searchByKeyword_Breakfast" style="height: 23px; width: 345px; border: 1px solid #999999; margin-top: 11px;padding-left: 35px"
                   onkeyup="show('searchByKeyword_Breakfast_Result');
                            getItemsByKeyword($('#searchByKeyword_Breakfast').val(),'searchByKeyword_Breakfast_Result',1, 'no');
            ...
            <div style="position: absolute; top: 45px; left: 23px; cursor: pointer;"
                 onclick="show('searchByKeyword_Breakfast_Result');
                          getItemsByKeyword($('#searchByKeyword_Breakfast').val(),'searchByKeyword_Breakfast_Result',1, 'yes');">
    ...
    <div id="tabSearchByMacronutrients_Breakfast" style="display: none">
        ...
        <div style="display: inline-block; cursor: pointer; position: relative; left: -20px; top: 4px;"  onclick="getItemsByMacronutrients($('#searchByCarbs_Breakfast').val(),$('#searchByProtein_Breakfast').val(),$('#searchByFat_Breakfast').val(),'searchByMacronutrients_Breakfast_Result',1);"><img src="/images/buttonSearchMag.gif" /></div>
        </div>
...
<div style="border-left: 1px solid #cccccc;border-right: 1px solid #cccccc;border-bottom: 1px solid #cccccc; width: 841px; background-color: #ffffff; margin-left: 12px;padding-left: 20px; padding-top: 16px; position: relative;margin-bottom: 10px;padding-bottom: 10px" id="addMealBreakfast_Search_Select">
    <div id="tabSearchMealByKeyword_Breakfast">
        ...
        <input type="text" id="searchMealByKeyword_Breakfast" style="height: 23px; width: 345px; border: 1px solid #999999; margin-top: 11px;padding-left: 35px"
               onkeyup="show('searchMealByKeyword_Breakfast_Result');
                        getMealsByKeyword($('#searchMealByKeyword_Breakfast').val(),'searchMealByKeyword_Breakfast_Result',1, 'no');" />
        <a style="padding-left: 24px; font-weight: bold; color: #e27424"
                  onclick="hide('tabSearchMealByKeyword_Breakfast');
                           show('tabSearchMealByMacronutrients_Breakfast');">By Macronutrients ></a>
        <div style="position: absolute; top: 45px; left: 23px; cursor: pointer;"
             onclick="show('searchMealByKeyword_Breakfast_Result');
                      getMealsByKeyword($('#searchMealByKeyword_Breakfast').val(),'searchMealByKeyword_Breakfast_Result',1, 'yes');"><img src="/images/buttonSearchMag.gif" /></div>
...
<div style="border-left: 1px solid #cccccc;border-right: 1px solid #cccccc;border-bottom: 1px solid #cccccc; width: 841px; background-color: #ffffff; margin-left: 12px;padding-left: 20px; padding-top: 16px; position: relative;margin-bottom: 10px;padding-bottom: 10px" id="addItemMorningTea_Search_Select">
        ...
        <div style="float:left;">
            <input type="text" id="searchByKeyword_MorningTea" style="height: 23px; width: 345px; border: 1px solid #999999; margin-top: 11px;padding-left: 35px"
                   onkeyup="show('searchByKeyword_MorningTea_Result');
                            getItemsByKeyword($('#searchByKeyword_MorningTea').val(),'searchByKeyword_MorningTea_Result',2, 'no');
                            showRight($(this),$('#rightMorningTea'));"/>
            <div style="position: absolute; top: 45px; left: 23px; cursor: pointer;"
                 onclick="show('searchByKeyword_MorningTea_Result');
                          getItemsByKeyword($('#searchByKeyword_MorningTea').val(),'searchByKeyword_MorningTea_Result',2, 'yes');"><img src="/images/buttonSearchMag.gif" /></div>
        </div>
    ...
    <div id="tabSearchByMacronutrients_MorningTea" style="display: none">
        ...
        <div style="display: inline-block; cursor: pointer; position: relative; left: -20px; top: 4px;"  onclick="getItemsByMacronutrients($('#searchByCarbs_MorningTea').val(),$('#searchByProtein_MorningTea').val(),$('#searchByFat_MorningTea').val(),'searchByMacronutrients_MorningTea_Result',2);"><img src="/images/buttonSearchMag.gif" /></div>
        </div>
...
<div style="border-left: 1px solid #cccccc;border-right: 1px solid #cccccc;border-bottom: 1px solid #cccccc; width: 841px; background-color: #ffffff; margin-left: 12px;padding-left: 20px; padding-top: 16px; position: relative;margin-bottom: 10px;padding-bottom: 10px" id="addMealMorningTea_Search_Select">
    <div id="tabSearchMealByKeyword_MorningTea">
        ...
        <input type="text" id="searchMealByKeyword_MorningTea" style="height: 23px; width: 345px; border: 1px solid #999999; margin-top: 11px;padding-left: 35px"
               onkeyup="show('searchMealByKeyword_MorningTea_Result');
                        getMealsByKeyword($('#searchMealByKeyword_MorningTea').val(),'searchMealByKeyword_MorningTea_Result',2, 'no');" />
        <a style="padding-left: 24px; font-weight: bold; color: #e27424"
                  onclick="hide('tabSearchMealByKeyword_MorningTea');
                           show('tabSearchMealByMacronutrients_MorningTea');">By Macronutrients ></a>
        <div style="position: absolute; top: 45px; left: 23px; cursor: pointer;"  onclick="show('searchMealByKeyword_MorningTea_Result');getMealsByKeyword($('#searchMealByKeyword_MorningTea').val(),'searchMealByKeyword_MorningTea_Result',2, 'yes');"><img src="/images/buttonSearchMag.gif" /></div>
        ...
        <div style="float:left;">
            <input type="text" id="searchByKeyword_Lunch" style="height: 23px; width: 345px; border: 1px solid #999999; margin-top: 11px;padding-left: 35px"
                   onkeyup="show('searchByKeyword_Lunch_Result');
                            getItemsByKeyword($('#searchByKeyword_Lunch').val(),'searchByKeyword_Lunch_Result',3, 'no');
                            showRight($(this),$('#rightLunch'));" />
        
            <div style="position: absolute; top: 45px; left: 23px; cursor: pointer;"
                 onclick="show('searchByKeyword_Lunch_Result');
                          getItemsByKeyword($('#searchByKeyword_Lunch').val(),'searchByKeyword_Lunch_Result',3, 'yes');"><img src="/images/buttonSearchMag.gif" /></div>
        </div>
...
<div style="border-left: 1px solid #cccccc;border-right: 1px solid #cccccc;border-bottom: 1px solid #cccccc; width: 841px; background-color: #ffffff; margin-left: 12px;padding-left: 20px; padding-top: 16px; position: relative;margin-bottom: 10px;padding-bottom: 10px" id="addMealLunch_Search_Select">
    <div id="tabSearchMealByKeyword_Lunch">
        <div style="font-weight: bold">Search by Keyword</div>
        <input type="text" id="searchMealByKeyword_Lunch" style="height: 23px; width: 345px; border: 1px solid #999999; margin-top: 11px;padding-left: 35px" onkeyup="show('searchMealByKeyword_Lunch_Result');getMealsByKeyword($('#searchMealByKeyword_Lunch').val(),'searchMealByKeyword_Lunch_Result',3, 'no');" />
        ...
        <div style="position: absolute; top: 45px; left: 23px; cursor: pointer;"  onclick="show('searchMealByKeyword_Lunch_Result');getMealsByKeyword($('#searchMealByKeyword_Lunch').val(),'searchMealByKeyword_Lunch_Result',3, 'yes');"><img src="/images/buttonSearchMag.gif" /></div>
...
<div style="border-left: 1px solid #cccccc;border-right: 1px solid #cccccc;border-bottom: 1px solid #cccccc; width: 841px; background-color: #ffffff; margin-left: 12px;padding-left: 20px; padding-top: 16px; position: relative;margin-bottom: 10px;padding-bottom: 10px" id="addItemAfternoonTea_Search_Select">
        ...
        <div style="float:left;">
            <input type="text" id="searchByKeyword_AfternoonTea" style="height: 23px; width: 345px; border: 1px solid #999999; margin-top: 11px;padding-left: 35px"
                   onkeyup="show('searchByKeyword_AfternoonTea_Result');
                            getItemsByKeyword($('#searchByKeyword_AfternoonTea').val(),'searchByKeyword_AfternoonTea_Result',4, 'no');
                            showRight($(this),$('#rightAfternoonTea'));" />        
            <div style="position: absolute; top: 45px; left: 23px; cursor: pointer;"
                 onclick="show('searchByKeyword_AfternoonTea_Result');
                 getItemsByKeyword($('#searchByKeyword_AfternoonTea').val(),'searchByKeyword_AfternoonTea_Result',4, 'yes');"><img src="/images/buttonSearchMag.gif" /></div>
        </div>
    ...
    <div id="tabSearchByMacronutrients_AfternoonTea" style="display: none">
        ...
        <div style="display: inline-block; cursor: pointer; position: relative; left: -20px; top: 4px;"  onclick="getItemsByMacronutrients($('#searchByCarbs_AfternoonTea').val(),$('#searchByProtein_AfternoonTea').val(),$('#searchByFat_AfternoonTea').val(),'searchByMacronutrients_AfternoonTea_Result',4);"><img src="/images/buttonSearchMag.gif" /></div>
        </div>
...
<div style="border-left: 1px solid #cccccc;border-right: 1px solid #cccccc;border-bottom: 1px solid #cccccc; width: 841px; background-color: #ffffff; margin-left: 12px;padding-left: 20px; padding-top: 16px; position: relative;margin-bottom: 10px;padding-bottom: 10px" id="addMealAfternoonTea_Search_Select">
    <div id="tabSearchMealByKeyword_AfternoonTea">
        <div style="font-weight: bold">Search by Keyword</div>
        <input type="text" id="searchMealByKeyword_AfternoonTea" style="height: 23px; width: 345px; border: 1px solid #999999; margin-top: 11px;padding-left: 35px" onkeyup="show('searchMealByKeyword_AfternoonTea_Result');getMealsByKeyword($('#searchMealByKeyword_AfternoonTea').val(),'searchMealByKeyword_AfternoonTea_Result',4, 'no');" />
        ...
        <div style="position: absolute; top: 45px; left: 23px; cursor: pointer;"  onclick="show('searchMealByKeyword_AfternoonTea_Result');getMealsByKeyword($('#searchMealByKeyword_AfternoonTea').val(),'searchMealByKeyword_AfternoonTea_Result',4, 'yes');"><img src="/images/buttonSearchMag.gif" /></div>
...
<div style="border-left: 1px solid #cccccc;border-right: 1px solid #cccccc;border-bottom: 1px solid #cccccc; width: 841px; background-color: #ffffff; margin-left: 12px;padding-left: 20px; padding-top: 16px; position: relative;margin-bottom: 10px;padding-bottom: 10px" id="addItemDinner_Search_Select">
        ...
        <div style="float:left;">
            <input type="text" id="searchByKeyword_Dinner" style="height: 23px; width: 345px; border: 1px solid #999999; margin-top: 11px;padding-left: 35px"
                   onkeyup="show('searchByKeyword_Dinner_Result');
                            getItemsByKeyword($('#searchByKeyword_Dinner').val(),'searchByKeyword_Dinner_Result',5, 'no');
                            showRight($(this),$('#rightDinner'));" />
        
            <div style="position: absolute; top: 45px; left: 23px; cursor: pointer;"  onclick="show('searchByKeyword_Dinner_Result');getItemsByKeyword($('#searchByKeyword_Dinner').val(),'searchByKeyword_Dinner_Result',5, 'yes');"><img src="/images/buttonSearchMag.gif" /></div>
        </div>
    ...
    <div id="tabSearchByMacronutrients_Dinner" style="display: none">
        ...
        <div style="display: inline-block; cursor: pointer; position: relative; left: -20px; top: 4px;"  onclick="getItemsByMacronutrients($('#searchByCarbs_Dinner').val(),$('#searchByProtein_Dinner').val(),$('#searchByFat_Dinner').val(),'searchByMacronutrients_Dinner_Result',5);"><img src="/images/buttonSearchMag.gif" /></div>
        </div>
...
<div style="border-left: 1px solid #cccccc;border-right: 1px solid #cccccc;border-bottom: 1px solid #cccccc; width: 841px; background-color: #ffffff; margin-left: 12px;padding-left: 20px; padding-top: 16px; position: relative;margin-bottom: 10px;padding-bottom: 10px" id="addMealDinner_Search_Select">
    <div id="tabSearchMealByKeyword_Dinner">
        <div style="font-weight: bold">Search by Keyword</div>
        <input type="text" id="searchMealByKeyword_Dinner" style="height: 23px; width: 345px; border: 1px solid #999999; margin-top: 11px;padding-left: 35px" onkeyup="show('searchMealByKeyword_Dinner_Result');getMealsByKeyword($('#searchMealByKeyword_Dinner').val(),'searchMealByKeyword_Dinner_Result',5, 'no');" />
        ...
        <div style="position: absolute; top: 45px; left: 23px; cursor: pointer;"  onclick="show('searchMealByKeyword_Dinner_Result');getMealsByKeyword($('#searchMealByKeyword_Dinner').val(),'searchMealByKeyword_Dinner_Result',5, 'yes');"><img src="/images/buttonSearchMag.gif" /></div>
...
<div style="border-left: 1px solid #cccccc;border-right: 1px solid #cccccc;border-bottom: 1px solid #cccccc; width: 841px; background-color: #ffffff; margin-left: 12px;padding-left: 20px; padding-top: 16px; position: relative;margin-bottom: 10px;padding-bottom: 10px" id="addItemSupper_Search_Select">
        ...
        <div style="float:left;">
            <input type="text" id="searchByKeyword_Supper" style="height: 23px; width: 345px; border: 1px solid #999999; margin-top: 11px;padding-left: 35px"
                   onkeyup="show('searchByKeyword_Supper_Result');
                            getItemsByKeyword($('#searchByKeyword_Supper').val(),'searchByKeyword_Supper_Result',6, 'no');
                            showRight($(this),$('#rightSupper'));" />       
            <div style="position: absolute; top: 45px; left: 23px; cursor: pointer;"
                 onclick="show('searchByKeyword_Supper_Result');
                          getItemsByKeyword($('#searchByKeyword_Supper').val(),'searchByKeyword_Supper_Result',6, 'yes');"><img src="/images/buttonSearchMag.gif" /></div>
        </div>
    ...
    <div id="tabSearchByMacronutrients_Supper" style="display: none">
        ...
        <div style="display: inline-block; cursor: pointer; position: relative; left: -20px; top: 4px;"  onclick="getItemsByMacronutrients($('#searchByCarbs_Supper').val(),$('#searchByProtein_Supper').val(),$('#searchByFat_Supper').val(),'searchByMacronutrients_Supper_Result',6);"><img src="/images/buttonSearchMag.gif" /></div>
        </div>
...
<div style="border-left: 1px solid #cccccc;border-right: 1px solid #cccccc;border-bottom: 1px solid #cccccc; width: 841px; background-color: #ffffff; margin-left: 12px;padding-left: 20px; padding-top: 16px; position: relative;margin-bottom: 10px;padding-bottom: 10px" id="addMealSupper_Search_Select">
    <div id="tabSearchMealByKeyword_Supper">
        <div style="font-weight: bold">Search by Keyword</div>
        <input type="text" id="searchMealByKeyword_Supper" style="height: 23px; width: 345px; border: 1px solid #999999; margin-top: 11px;padding-left: 35px" onkeyup="show('searchMealByKeyword_Supper_Result');getMealsByKeyword($('#searchMealByKeyword_Supper').val(),'searchMealByKeyword_Supper_Result',6, 'no');" />
        ...
        <div style="position: absolute; top: 45px; left: 23px; cursor: pointer;"  onclick="show('searchMealByKeyword_Supper_Result');getMealsByKeyword($('#searchMealByKeyword_Supper').val(),'searchMealByKeyword_Supper_Result',6, 'yes');"><img src="/images/buttonSearchMag.gif" /></div>
  ...
  <% } %>
    ...
    <table>
        ...
        <tr id="totmacroavetd" runat="server" ClientIDMode="Static">
            <td>
                <p style="padding-bottom: 10px; font-size: 15px;">Weekly Actual Ave</p>
            </td>
            <td>
    ...
    <div style="font-weight: bold; font-size: 14px;float: left; padding-top: 4px; padding-right: 10px">Food Diary for week: </div>
    <div style="border: 1px solid #999999; padding: 1px;float: left; height: 21px; width: 280px" class="cal_controls">
<asp:ImageButton runat="server" ID="buttonWeekNext"  
        onclick="buttonWeekNext_Click" ImageUrl="~/images/calendar_forward.gif" style="float: right" />
<asp:ImageButton runat="server" ID="buttonWeekPrev"
        onclick="buttonWeekPrev_Click" ImageUrl="~/images/calendar_back.gif" style="float: left" />
...
<div style="float: right; text-align: right; padding-right: 11px; position: relative"><img id="imgWeekReset" src="/images/buttonResetWeek.gif" style="cursor: pointer;" alt="Reset This Week"/><img src="/images/buttonPrint.png" style="cursor: pointer" alt="Print" onclick="popup_and_print()" /><a style="cursor: pointer" onclick="printShoppingList();"><img src="/images/buttonPrintShoppingList.gif" /></a> </div>

<table width="884" border="0" cellpadding="0" cellspacing="0" style="padding-top:20px" id="foodDiaryWeek">
<tr>
<td width="44">&nbsp;</td>
<td width="120" class="foodDairyWeekHeader" data-day="1" id="startDateofTheWeek"><asp:Literal runat="server" ID="literalDay1DateLink"></asp:Literal></td>
<td width="120" class="foodDairyWeekHeader" data-day="2"><asp:Literal runat="server" ID="literalDay2DateLink"></asp:Literal></td>
<td width="120" class="foodDairyWeekHeader" data-day="3"><asp:Literal runat="server" ID="literalDay3DateLink"></asp:Literal></td>
<td width="120" class="foodDairyWeekHeader" data-day="4"><asp:Literal runat="server" ID="literalDay4DateLink"></asp:Literal></td>
<td width="120" class="foodDairyWeekHeader" data-day="5"><asp:Literal runat="server" ID="literalDay5DateLink"></asp:Literal></td>
<td width="120" class="foodDairyWeekHeader" data-day="6"><asp:Literal runat="server" ID="literalDay6DateLink"></asp:Literal></td>
<td width="120" class="foodDairyWeekHeader" data-day="7"><asp:Literal runat="server" ID="literalDay7DateLink"></asp:Literal></td>
</tr>
<tr>
<td class="foodDairyWeekRowTitle" id="rowTitleMenu"><img src="/images/vertMenu.gif" /></td>
<td class="foodDairyWeekMenu" data-day="1"><asp:Literal runat="server" ID="literalDay1Menu"></asp:Literal></td>
<td class="foodDairyWeekMenu" data-day="2"><asp:Literal runat="server" ID="literalDay2Menu"></asp:Literal></td>
<td class="foodDairyWeekMenu" data-day="3"><asp:Literal runat="server" ID="literalDay3Menu"></asp:Literal></td>
<td class="foodDairyWeekMenu" data-day="4"><asp:Literal runat="server" ID="literalDay4Menu"></asp:Literal></td>
<td class="foodDairyWeekMenu" data-day="5"><asp:Literal runat="server" ID="literalDay5Menu"></asp:Literal></td>
<td class="foodDairyWeekMenu" data-day="6"><asp:Literal runat="server" ID="literalDay6Menu"></asp:Literal></td>
<td class="foodDairyWeekMenu" data-day="7"><asp:Literal runat="server" ID="literalDay7Menu"></asp:Literal></td>
</tr>
<tr> <!--new macro -->
<td class="foodDairyWeekRowTitle" id="Td1"><img src="/images/vertMacros.gif" /></td>
<td class="foodDairyWeekHeader day1macro"><asp:Literal runat="server" ID="literalDay1MacrosDiff"></asp:Literal></td>
<td class="foodDairyWeekHeader day2macro"><asp:Literal runat="server" ID="literalDay2MacrosDiff"></asp:Literal></td>
<td class="foodDairyWeekHeader day3macro"><asp:Literal runat="server" ID="literalDay3MacrosDiff"></asp:Literal></td>
<td class="foodDairyWeekHeader day4macro"><asp:Literal runat="server" ID="literalDay4MacrosDiff"></asp:Literal></td>
<td class="foodDairyWeekHeader day5macro"><asp:Literal runat="server" ID="literalDay5MacrosDiff"></asp:Literal></td>
<td class="foodDairyWeekHeader day6macro"><asp:Literal runat="server" ID="literalDay6MacrosDiff"></asp:Literal></td>
<td class="foodDairyWeekHeader day7macro"><asp:Literal runat="server" ID="literalDay7MacrosDiff"></asp:Literal></td>
</tr><!-- end new macro -->
<tr>
<td class="foodDairyWeekRowTitle" id="rowTitleBreakfast"><img src="/images/vertBreakfast.gif" /></td>
<td class="foodDairyWeekCell" data-day="1" data-mealtimeid="1"><asp:Literal runat="server" ID="literalDay1Breakfast"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="2" data-mealtimeid="1"><asp:Literal runat="server" ID="literalDay2Breakfast"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="3" data-mealtimeid="1"><asp:Literal runat="server" ID="literalDay3Breakfast"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="4" data-mealtimeid="1"><asp:Literal runat="server" ID="literalDay4Breakfast"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="5" data-mealtimeid="1"><asp:Literal runat="server" ID="literalDay5Breakfast"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="6" data-mealtimeid="1"><asp:Literal runat="server" ID="literalDay6Breakfast"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="7" data-mealtimeid="1"><asp:Literal runat="server" ID="literalDay7Breakfast"></asp:Literal></td>
</tr>
<tr>
<td class="foodDairyWeekRowTitle" id="rowTitleMorningTea"><img src="/images/vertMorningTea.gif" /></td>
<td class="foodDairyWeekCell" data-day="1" data-mealtimeid="2"><asp:Literal runat="server" ID="literalDay1MorningTea"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="2" data-mealtimeid="2"><asp:Literal runat="server" ID="literalDay2MorningTea"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="3" data-mealtimeid="2"><asp:Literal runat="server" ID="literalDay3MorningTea"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="4" data-mealtimeid="2"><asp:Literal runat="server" ID="literalDay4MorningTea"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="5" data-mealtimeid="2"><asp:Literal runat="server" ID="literalDay5MorningTea"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="6" data-mealtimeid="2"><asp:Literal runat="server" ID="literalDay6MorningTea"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="7" data-mealtimeid="2"><asp:Literal runat="server" ID="literalDay7MorningTea"></asp:Literal></td>
</tr>
<tr>
<td class="foodDairyWeekRowTitle" id="rowTitleLunch"><img src="/images/vertLunch.gif" /></td>
<td class="foodDairyWeekCell" data-day="1" data-mealtimeid="3"><asp:Literal runat="server" ID="literalDay1Lunch"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="2" data-mealtimeid="3"><asp:Literal runat="server" ID="literalDay2Lunch"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="3" data-mealtimeid="3"><asp:Literal runat="server" ID="literalDay3Lunch"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="4" data-mealtimeid="3"><asp:Literal runat="server" ID="literalDay4Lunch"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="5" data-mealtimeid="3"><asp:Literal runat="server" ID="literalDay5Lunch"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="6" data-mealtimeid="3"><asp:Literal runat="server" ID="literalDay6Lunch"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="7" data-mealtimeid="3"><asp:Literal runat="server" ID="literalDay7Lunch"></asp:Literal></td>
</tr>
<tr>
<td class="foodDairyWeekRowTitle" id="rowTitleAfternoonTea"><img src="/images/vertAfternoonTea.gif" /></td>
<td class="foodDairyWeekCell" data-day="1" data-mealtimeid="4"><asp:Literal runat="server" ID="literalDay1AfternoonTea"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="2" data-mealtimeid="4"><asp:Literal runat="server" ID="literalDay2AfternoonTea"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="3" data-mealtimeid="4"><asp:Literal runat="server" ID="literalDay3AfternoonTea"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="4" data-mealtimeid="4"><asp:Literal runat="server" ID="literalDay4AfternoonTea"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="5" data-mealtimeid="4"><asp:Literal runat="server" ID="literalDay5AfternoonTea"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="6" data-mealtimeid="4"><asp:Literal runat="server" ID="literalDay6AfternoonTea"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="7" data-mealtimeid="4"><asp:Literal runat="server" ID="literalDay7AfternoonTea"></asp:Literal></td>
</tr>
<tr>
<td class="foodDairyWeekRowTitle" id="rowTitleDinner"><img src="/images/vertDinner.gif" /></td>
<td class="foodDairyWeekCell" data-day="1" data-mealtimeid="5"><asp:Literal runat="server" ID="literalDay1Dinner"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="2" data-mealtimeid="5"><asp:Literal runat="server" ID="literalDay2Dinner"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="3" data-mealtimeid="5"><asp:Literal runat="server" ID="literalDay3Dinner"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="4" data-mealtimeid="5"><asp:Literal runat="server" ID="literalDay4Dinner"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="5" data-mealtimeid="5"><asp:Literal runat="server" ID="literalDay5Dinner"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="6" data-mealtimeid="5"><asp:Literal runat="server" ID="literalDay6Dinner"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="7" data-mealtimeid="5"><asp:Literal runat="server" ID="literalDay7Dinner"></asp:Literal></td>
</tr>
<tr>
<td class="foodDairyWeekRowTitle" id="rowTitleSupper"><img src="/images/vertSupper.gif" /></td>
<td class="foodDairyWeekCell" data-day="1" data-mealtimeid="6"><asp:Literal runat="server" ID="literalDay1Supper"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="2" data-mealtimeid="6"><asp:Literal runat="server" ID="literalDay2Supper"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="3" data-mealtimeid="6"><asp:Literal runat="server" ID="literalDay3Supper"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="4" data-mealtimeid="6"><asp:Literal runat="server" ID="literalDay4Supper"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="5" data-mealtimeid="6"><asp:Literal runat="server" ID="literalDay5Supper"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="6" data-mealtimeid="6"><asp:Literal runat="server" ID="literalDay6Supper"></asp:Literal></td>
<td class="foodDairyWeekCell" data-day="7" data-mealtimeid="6"><asp:Literal runat="server" ID="literalDay7Supper"></asp:Literal></td>
</tr>

<tr>
<td class="foodDairyWeekRowTitle" id="rowTitleMacros"><img src="/images/vertMacros.gif" /></td>
<td class="foodDairyWeekHeader day1macro"><asp:Literal runat="server" ID="literalDay1Macros"></asp:Literal></td>
<td class="foodDairyWeekHeader day2macro"><asp:Literal runat="server" ID="literalDay2Macros"></asp:Literal></td>
<td class="foodDairyWeekHeader day3macro"><asp:Literal runat="server" ID="literalDay3Macros"></asp:Literal></td>
<td class="foodDairyWeekHeader day4macro"><asp:Literal runat="server" ID="literalDay4Macros"></asp:Literal></td>
<td class="foodDairyWeekHeader day5macro"><asp:Literal runat="server" ID="literalDay5Macros"></asp:Literal></td>
<td class="foodDairyWeekHeader day6macro"><asp:Literal runat="server" ID="literalDay6Macros"></asp:Literal></td>
<td class="foodDairyWeekHeader day7macro"><asp:Literal runat="server" ID="literalDay7Macros"></asp:Literal></td>
</tr>
