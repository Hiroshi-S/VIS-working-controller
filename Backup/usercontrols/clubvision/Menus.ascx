<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Menus.ascx.cs" Inherits="VisionPersonalTrainingProject.usercontrols.clubvision.Menus" %>
<%@ Register Assembly="BasicFrame.WebControls.BasicDatePicker" Namespace="BasicFrame.WebControls"
    TagPrefix="BDP" %>

<div id="eMenu" class="element">
        <div class="replace" id="menuTab" runat="server">
            <div id="tabVisionMenus" style="cursor: pointer; position: absolute; top: 0px; left: 0px; width: 261px; height: 45px" onclick="document.location = '/club-vision/Redirecting?page=/club-vision/my-eating/menus/?tab=visionsmenus';"></div>
            <div id="tabMyMenus" style="cursor: pointer; position: absolute; top: 0px; left: 262px; width: 201px; height: 45px" onclick="document.location = '/club-vision/Redirecting?page=/club-vision/my-eating/menus/?tab=mymenus';"></div>
            <div id="tabVisionMeals" style="cursor: pointer; position: absolute; top: 0px; left: 464px; width: 201px; height: 45px" onclick="document.location = '/club-vision/Redirecting?page=/club-vision/my-eating/menus/?tab=visionsmeals';"></div>
            <div id="tabMyMeals" style="cursor: pointer; position: absolute; top: 0px; left: 666px; width: 201px; height: 45px" onclick="document.location = '/club-vision/Redirecting?page=/club-vision/my-eating/menus/?tab=mymeals';"></div>
        </div>
    ...
    <div id="pVisionMealsSearch" runat="server" visible="false">
        ...
        <div  id="pVisionMealsSearchDiv" style="padding-top: 10px;border: 1px solid #d1d1d1; display: none; width: 857px;margin-left: 14px; margin-top: 20px; background-color: #ececec">
            ...
            <div style="border-left: 1px solid #cccccc;border-right: 1px solid #cccccc;border-bottom: 1px solid #cccccc; width: 800px; background-color: #ffffff; margin-left: 12px;padding-left: 20px; padding-top: 16px; position: relative;margin-bottom: 10px;padding-bottom: 10px" id="pVisionMealsSearchSearchByKeyword">
...
<div style="font-weight: bold; font-size: 14px;float: left; padding-top: 4px; padding-right: 10px">Menu Name: </div>
<input type="text" id="menuName" runat="server" style="width: 200px; height: 21px; border: 1px solid #999999; float: left" onblur="menu_editName(this.value.replace('&','%26'));" />
<div style="float: right; text-align: right; padding-right: 11px; position: relative"><a id="saveMenu" runat="server"><img src="/images/buttonSave.gif" runat="server" id="saveMenuImage" style="cursor: pointer" alt="Save"  onclick="$('#menu_resultPage').html('Saved.').css('display','block');" /></a> 
</div>
<div style="clear:both"></div>
...
<a runat="server" id="saveMeal">
    <img src="/images/buttonSave.gif" runat="server" id="saveMealImage" style="float: right; cursor: pointer" alt="Save"  onclick="$('#resultPage_Meal').html('Saved.').css('display','block');" />
</a> 
<a ID="lnkTV" runat="server" style="float: right">
    <img src="/images/buttonViewOnVisionTV.png" alt="View on Vision TV" />
</a> 
<a ID="lnkShare" target="_blank" runat="server" style="float: right; cursor: pointer;" onclick="var result = toggle_str('shareDailyPlan_Select');hide_one_of();switchto('shareDailyPlan_Select', result);">
    <img src="/images/buttonShare.gif" alt="Share your" />
</a> 
<a ID="lnkDL" target="_blank" runat="server" style="float: right;cursor: pointer;">
    <img src="/images/buttonDownload.png" alt="Download" id="downloadRecipeImage" runat="server"/>
</a>

<a ID="lnkEditPortion" target="_blank" runat="server" style="float: right;cursor: pointer;" Visible="False" onclick="var result = toggle_str('editPortionDiv');hide_one_of();switchto('editPortionDiv', result);">
    <img src="/images/buttonEditPortion.gif" alt="Download" id="ImgEditPortion" runat="server"/>
</a>

<div style="clear:both"></div>
<div style="top: 321px; left: 687px; border: 1px solid #a0a0a0; display: none; position: absolute; width: 186px; height: 144px; padding-top: 6px; padding-left: 12px; background-color: #f1f1f1; font-weight: bold;text-align: left; z-index: 100;" id="shareDailyPlan_Select" runat="server" clientidmode="Static" class="one_of">
    <p>Share to?</p>
    ...
    <div class="quicktools_option" style="height:25px;text-align:left;vertical-align:middle;" id="shareToHQ" runat="server"><img src="/images/favicon002.png" height="21" width="21"/>&nbsp;&nbsp;&nbsp;Vision Meals</div>
...
<div style="top: 321px; left: 600px; border: 1px solid #a0a0a0; display: none; position: absolute; width: 150px; height:94px; padding-top: 6px; padding-left: 12px; background-color: #f1f1f1; font-weight: bold;text-align: left; z-index: 100;" id="editPortionDiv" class="one_of" clientidmode="Static">
        <p>Divide this meal by</p><br/>
        <p><input type="number" id="serveByNum" style="width: 50px;"/> portions</p>
        <p><input type="submit" value="Go" onclick="hide_one_of();MealDivideByNumberServing($('#serveByNum').val(), $('#ContentPlaceHolderDefault_ContentPlaceHolderMain_Menus_2_currentMealId').val()); return  false;" style="float: right;margin-right: 7px;"/>
        </p>
</div>
<div id="mealImgDiv" runat="server">
    <img id="mealImg" alt="Meal Image" runat="server" src="/images/meals/meal_generic.jpg" width="144" height="144" style="margin-top: -30px;box-shadow: 0px 0px 5px 0px rgba(50, 50, 50, 0.75);float:left;" />
    <div id="editMealImgDiv" style="background: #ffffff;width: 120px;float: left;height: 20px;font-weight: bold;color: black;border-radius: 3px; -moz-border-radius: 3px;text-align: center;line-height: 20px;margin-left: -132px;margin-top: 80px;display:none;cursor: pointer;" runat="server" ClientIDMode="Static">Edit Photo</div>
</div>
<div style="font-weight: bold; font-size: 30px;float: left; padding-top: 17px; padding-left: 20px;min-width: 300px;" id="mealNameDiv" runat="server">Meal Name: </div>

<div id="singlePortionDiv" style="width: 710px;height: 50px;display: none;float: left;padding-left: 20px;margin-top: 2px;" class="uploaddiv" runat="server" clientidmode="Static">
    ...
    <!--Every meal has to be single serving portion for your convenient adding it to Food Diary. However, when creating a meal you don't have to struggle dividing each item
    per serving as you go. Simply just add every food item as normal like it is written in your recipe book, then when you finish click on edit portion above below to adjust 
    your meal as single serve portion and they are ready to go to your Food Diary.-->
...
<div id="mealImageUploadDiv" style="width: 500px;height: 50px;display: none;float: left;padding-left: 20px;margin-top: 6px;" class="uploaddiv">
    ...
    <a onclick="$('#mealImageUploadDiv').slideToggle();" style="cursor: pointer;position: relative;left: 11px;top: 3px;"><img src="/images/delete.gif" border="0"></a>
    <br/>    
...
<div id="mealRecipeUploadDiv" style="width: 500px;height: 50px;display: none;float: left;padding-left: 20px;margin-top: 6px;" class="uploaddiv" clientidmode="Static">
    ...
    <a onclick="$('#mealRecipeUploadDiv').slideToggle();" style="cursor: pointer;position: relative;left: 11px;top: 3px;"><img src="/images/delete.gif" border="0"></a>
    <br/>
    <i>Accepts only .pdf, .doc, .docx, .txt and size no bigger than 100 KB</i>
    <br/>
...
<tr>
<td style="border-top: 1px solid #e5e5e5; padding-top: 15px; padding-bottom: 15px; font-size: 12px; font-weight: bold; text-align: center;" width="185">&nbsp;</td>
<td style="border-top: 1px solid #e5e5e5; padding-top: 15px; padding-bottom: 15px; font-size: 12px; font-weight: bold; text-align: center;" width="184">&nbsp;</td>
<td style="border-top: 1px solid #e5e5e5; padding-top: 15px; padding-bottom: 15px; font-size: 12px; font-weight: bold; text-align: center;" width="100">Serve</td>
<td style="border-top: 1px solid #e5e5e5; padding-top: 15px; padding-bottom: 15px; font-size: 12px; font-weight: bold; text-align: center;" width="100">Amount</td>
<td style="border-top: 1px solid #e5e5e5; padding-top: 15px; padding-bottom: 15px; font-size: 12px; font-weight: bold; text-align: center;" width="100">Carbohydrate(g)</td>
<td style="border-top: 1px solid #e5e5e5; padding-top: 15px; padding-bottom: 15px; font-size: 12px; font-weight: bold; text-align: center;" width="100">Protein(g)</td>
<td style="border-top: 1px solid #e5e5e5; padding-top: 15px; padding-bottom: 15px; font-size: 12px; font-weight: bold; text-align: center;" width="100">Fat(g)</td>
<td style="border-top: 1px solid #e5e5e5; padding-top: 15px; padding-bottom: 15px; font-size: 12px; font-weight: bold; text-align: center;" width="16">&nbsp;</td>
</tr>
...
<tr>
<td style="padding-top: 15px;padding-left: 15px;" colspan="4">Per Portion</td>
...
<div style="float: left;display: block;width: 515px;padding-left: 15px;font-size: 14px; color: #e27424;padding-top: 10px;" id="singlePortionTitle" runat="server" Visible="False">
    Please note that all meal items will be added to your food database automatically
</div>
    <div class="clear">&nbsp;</div>    
</div>
</div>
