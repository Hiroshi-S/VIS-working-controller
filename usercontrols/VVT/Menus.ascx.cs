...
/*
 * [1] Dewi 07/02/2014 > New Face for Menus Page
 */
namespace VisionPersonalTrainingProject.usercontrols.VVT
{
    public partial class Menus : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                if (Request.QueryString["tab"] == null || Request.QueryString["tab"] == "mymenus" || Request.QueryString["tab"] == "visionsmenus")
                {
                    ...
                    decimal m_carb = (Request.QueryString["carb"] == null || Request.QueryString["carb"] == "")
                                                 ? c_carb
                                                 : Convert.ToDecimal(Request.QueryString["carb"]);

                    decimal m_protein = (Request.QueryString["protein"] == null || Request.QueryString["protein"] == "")
                                         ? c_ptn
                                         : Convert.ToDecimal(Request.QueryString["protein"]);

                    decimal m_fat = (Request.QueryString["fat"] == null || Request.QueryString["fat"] == "")
                                         ? c_fat
                    ...
                    foreach (GetMenusByMacro_MenuPageResult menu in menus)
                    {
                        ...
                        literalMenus.Text += "<p class=\"title\"><a href=\"?tab=" + (Request.QueryString["tab"] == "visionsmenus" ? ((string)Session["Admin"] == "Yes" ? "edit" : "view") : "edit") + "&menuId=" + menu.Id + "\">" + menu.Name + "</a></p>";
                        ...
                        {
                            literalMenus.Text += "<a href=\"?tab=" + (Request.QueryString["tab"] == "visionsmenus" ? ((string)Session["Admin"] == "Yes" ? "edit" : "view") : "edit") + "&menuId=" + menu.Id + "\"><img class=\"menu_image\" src=\"/images/menus/" + menu.ImageUrl + "\" style=\"position:relative; top: 15px;left:1px;height:144px;width:144px;\"/></a>";
                        }
                        ...
                        literalMenus.Text += "<div class=\"macro\">";
                        literalMenus.Text += "<table>" +
                                             "<tr><td>Carbs</td><td>Protein</td><td>Fat</td></tr>" +
                                             "<tr><td><span class=\"macro-carb\">" + carbohydrate.ToString("0.00") +
                                             "</span></td>" +
                                             "<td><span class=\"macro-ptn\">" + protein.ToString("0.00") +
                                             "</span></td>" +
                                             "<td><span class=\"macro-fat\">" + fat.ToString("0.00") +
                                             "</span></td></tr>" +
                                             "</table></div>";

                        literalMenus.Text += "<div class=\"controls\">";
                        literalMenus.Text += "<img src=\"/images/icons/web/addtofooddiary.png\" alt=\"Add to Diary\" title=\"Add Daily Plan to Diary\" onclick=\"var result = toggle_str('menu_" + menu.Id + "');hide_one_of();switchto('menu_" + menu.Id + "', result);\" />";
                        literalMenus.Text += "<img src=\"/images/icons/web/closedenvelope.png\" alt=\"Share Daily Plan\" title=\"Share Daily Plan\" onclick=\"var result = toggle_str('share_menu_" + menu.Id + "');hide_one_of();switchto('share_menu_" + menu.Id + "', result);\" />";
                        literalMenus.Text += "<a onclick=\"popup_and_printURL('/club-vision/my-eating/menus/?tab=view&menuId=" + menu.Id + "');\"><img src=\"/images/icons/web/print.png\" alt=\"Print\" /></a>";
                        if (Request.QueryString["tab"] == null || Request.QueryString["tab"] == "mymenus")
                        {
                            literalMenus.Text += "<a href=\"?tab=edit&menuId=" + menu.Id + "\"><img src=\"/images/icons/web/edit.png\" alt=\"Edit\" title=\"Edit Daily Plan\"/></a>";
                            literalMenus.Text += "<img src=\"/images/icons/web/delete.png\" alt=\"Delete\" title=\"Delete daily Plan\" onclick=\"delete_menu(" + menu.Id + ");\" />";

                        }
                        literalMenus.Text += "<div id=\"menu_" + menu.Id + "\" class=\"one_of sharemealdialog\">";
                        ...
                        literalMenus.Text += "<div id=\"share_menu_" + menu.Id + "\" class=\"one_of sharemealdialog\">";
                        ...
                        literalMenus.Text += "<div class=\"quicktools_option\" style=\"height:25px;text-align:left;vertical-align:middle;\" onclick=\"ShareMenuOrMeal(2, " + menu.Id + ", -1, 'twitter')\"><img src=\"/images/twitter-icon.png\" /> &nbsp;&nbsp;&nbsp;Twitter</div>";
                        if (Session["MemberType"].Equals("VPT"))
                        {
                            literalMenus.Text += Session["Trainer"].Equals("No") ? "<div class=\"quicktools_option\" style=\"height:25px;text-align:left;vertical-align:middle;\" onclick=\"ShareMenuOrMeal(2, " + menu.Id + ", -1, 'trainer')\"><img src=\"/images/trainer.small.icon.jpg\" />&nbsp;&nbsp;&nbsp;My Trainer</div>" :
                                                                                "<div class=\"quicktools_option\" style=\"height:25px;text-align:left;vertical-align:middle;\" onclick=\"ShareMenuOrMeal(2, " + menu.Id + ", -1, 'clients')\"><img src=\"/images/trainer.small.icon.jpg\" />&nbsp;&nbsp;&nbsp;My Clients</div>";
                        
                        }
                        if (Request.QueryString["tab"] == null || Request.QueryString["tab"] == "mymenus")
                        {
                            literalMenus.Text += "<div class=\"quicktools_option\" style=\"height:25px;text-align:left;vertical-align:middle;\" onclick=\"hide_one_of();ShareMenuOrMeal(2," + menu.Id + ",-1,'VVTHQ'); return  false;\"><img src=\"/images/favicon002.png\" Height=\"21\" Width=\"21\"/>&nbsp;&nbsp;&nbsp;Vision HQ</div>";
                        }
                        literalMenus.Text += "<div class=\"quicktools_option\" style=\"height:25px;text-align:left;vertical-align:middle;\" onclick=\"hide_one_of();enterEmailToShare('ShareMenuOrMeal(2," + menu.Id + ",-1,email)'); return false;\"><img src=\"/images/email_icon.png\" />&nbsp;&nbsp;&nbsp;Email</div>";
                        literalMenus.Text += "</div>";
                        literalMenus.Text += "</div>";
                        literalMenus.Text += "</div>";
                        Math.DivRem(count, 2, out result);
                ...
                if (Request.QueryString["tab"] == "visionsmeals" || Request.QueryString["tab"] == "mymeals")
                {
                    ...
                    foreach (GetMealsForCustomerResult meal in _meals)
                    {
                        ...
                        literalMenus.Text += "<p class=\"title\"><a href=\"?tab=" + (Request.QueryString["tab"] == "visionsmeals" ? ((string)Session["Admin"] == "Yes" ? "edit" : "view") : "edit") + "_meal&mealId=" + meal.Id + "\">" + meal.Name + "</a></p>";
                        ...
                        {
                            literalMenus.Text += "<a href=\"?tab=" + (Request.QueryString["tab"] == "visionsmeals" ? ((string)Session["Admin"] == "Yes" ? "edit" : "view") : "edit") + "_meal&mealId=" + meal.Id + "\"><div style=\"position:relative; top: 15px;left:1px;height: 144px; width: 144px;overflow: hidden;float:left;\"><img class=\"menu_image thumb\" src=\"/images/meals/" + meal.ImageUrl + "\" style=\"position:absolute; height: 144px; width: 192px;left: -24px;\"/></div></a>";
                        }
                        else
                        {
                            if (meal.ImageUrl != null)
                            {
                                literalMenus.Text += "<a href=\"?tab=" + (Request.QueryString["tab"] == "visionsmeals" ? ((string)Session["Admin"] == "Yes" ? "edit" : "view") : "edit") + "_meal&mealId=" + meal.Id + "\"><div style=\"position:relative; top: 15px;left:1px;height: 144px; width: 144px;overflow: hidden;float:left;\"><img class=\"menu_image\" src=\"/images/meals/" + meal.ImageUrl + "\" style=\"position:absolute;height: 144px; width: 144px;\"/></div></a>";
                            }
                            else
                            {
                                literalMenus.Text += "<a href=\"?tab=" + (Request.QueryString["tab"] == "visionsmeals" ? ((string)Session["Admin"] == "Yes" ? "edit" : "view") : "edit") + "_meal&mealId=" + meal.Id + "\"><div style=\"position:relative; top: 15px;left:1px;height: 144px; width: 144px;overflow: hidden;float:left;\"><img class=\"menu_image\" src=\"/images/menus/meal_generic.jpg\" style=\"position:absolute;height: 144px; width: 144px;\"/></div></a>";
                            }
                        }

                        if (meal.MealTagPictures == null)
                        {
                            if (meal.MealDescription == null)
                            {
                                literalMenus.Text += "<ul>";
                                literalMenus.Text += meal.MealItems.Replace("&lt;", "<").Replace("&gt;", ">");
                                literalMenus.Text += meal.TripleDot;
                                literalMenus.Text += "</ul>";
                            }
                            else
                            {
                                literalMenus.Text += "<div class=\"mealdesc\">\"" + meal.MealDescription + "\"</div>";
                            }
                        }
                        else
                        {
                            literalMenus.Text += "<ul>";
                            literalMenus.Text += meal.MealTagPictures.Replace("&lt;", "<").Replace("&gt;", ">");
                            literalMenus.Text += "</ul>";
                        }

                        carbohydrate = Convert.ToDecimal(meal.CarbohydrateSum);
                        protein = Convert.ToDecimal(meal.ProteinSum);
                        fat = Convert.ToDecimal(meal.FatSum);
                        ...
                        literalMenus.Text += "<table>" +
                                             ...
                                             "<td><span class=\"macro-fat\">" + fat.ToString("0.00") +
                                             "</span></td></tr>" +
                                             "<tr><td colspan=\"3\">per serve (g)</td></tr>" +
                                             "</table></div>";


                        literalMenus.Text += "<div class=\"controls\">";
                        literalMenus.Text += "<img src=\"/images/icons/web/addtofooddiary.png\" alt=\"Add to Diary\" title=\"Add to Food Diary\" onclick=\"var result = toggle_str('meal_" + meal.Id + "');hide_one_of();switchto('meal_" + meal.Id + "', result);\" />";
                        literalMenus.Text += "<img src=\"/images/icons/web/closedenvelope.png\" alt=\"Share Meal\" title=\"Share Meal\" onclick=\"var result = toggle_str('share_meal_" + meal.Id + "');hide_one_of();switchto('share_meal_" + meal.Id + "', result);\" />";
                        if (Request.QueryString["tab"] == "mymeals")
                        {
                            literalMenus.Text += "<a href=\"?tab=edit_meal&mealId=" + meal.Id + "\"><img src=\"/images/icons/web/edit.png\" alt=\"Edit\" title=\"Edit Meal\" /></a>";
                            literalMenus.Text += "<img src=\"/images/icons/web/delete.png\" alt=\"Delete\" title=\"Delete Meal\" style=\"cursor: pointer\" onclick=\"delete_meal(" + meal.Id + ");\" />";

                        }
                        if (meal.VideoId != null)
                        {
                            literalMenus.Text += "<a href=\"/club-vision/education/vision-tv?vid=" + meal.VideoId + "\"><img src=\"/images/icons/web/mediaplay.png\" alt=\"Play\" title=\"Watch Video\" /></a>";
                            if (meal.PDFAddress != null)
                            {
                                literalMenus.Text += "<a href=\"/media" + meal.PDFAddress + "\" target=\"_blank\"><img src=\"/images/icons/web/download.png\" alt=\"Download\" title=\"Download Recipe\" /></a>";
                            }
                        }
                        if (meal.PDFAddress != null && meal.VideoId == null)
                        {
                            literalMenus.Text += "<a href=\"/club-vision/recipe/" + meal.PDFAddress + "\" target=\"_blank\"><img src=\"/images/icons/web/download.png\" alt=\"Download\" title=\"Download Recipe\" /></a>";
                        }
                        literalMenus.Text += "<div id=\"meal_" + meal.Id + "\" class=\"one_of sharemealdialog\">";
                        ...
                        literalMenus.Text += "<div id=\"share_meal_" + meal.Id + "\" class=\"one_of sharemealdialog\">";
                        literalMenus.Text += "<div class=\"quicktools_copyto_header\">Share to?</div>"; //ShareMenuOrMeal(shareType, menuid, mealid, sharevia)
                        ...
                        literalMenus.Text += "<div class=\"quicktools_option\" style=\"height:25px;text-align:left;vertical-align:middle;\" onclick=\"hide_one_of();ShareMenuOrMeal(3,-1," + meal.Id + ",'twitter'); return  false;\"><img src=\"/images/twitter-icon.png\" /> &nbsp;&nbsp;&nbsp;Twitter</div>";
                        if (Session["MemberType"].Equals("VPT"))
                        {
                            literalMenus.Text += Session["Trainer"].Equals("No") ? "<div class=\"quicktools_option\" style=\"height:25px;text-align:left;vertical-align:middle;\" onclick=\"hide_one_of();ShareMenuOrMeal(3,-1," + meal.Id + ",'trainer'); return  false;\"><img src=\"/images/trainer.small.icon.jpg\" />&nbsp;&nbsp;&nbsp;My Trainer</div>" :
                                "<div class=\"quicktools_option\" style=\"height:25px;text-align:left;vertical-align:middle;\" onclick=\"hide_one_of();ShareMenuOrMeal(3,-1," + meal.Id + ",'clients'); return  false;\"><img src=\"/images/trainer.small.icon.jpg\" />&nbsp;&nbsp;&nbsp;My Clients</div>";
                        }
                        if (Request.QueryString["tab"] == "mymeals")
                        {
                            literalMenus.Text += "<div class=\"quicktools_option\" style=\"height:25px;text-align:left;vertical-align:middle;\" onclick=\"hide_one_of();ShareMenuOrMeal(3,-1," + meal.Id + ",'VVTHQ'); return  false;\"><img src=\"/images/favicon002.png\" Height=\"21\" Width=\"21\"/>&nbsp;&nbsp;&nbsp;Vision HQ</div>";
                        }
                ...
                {
                    case "edit": TabEditMenu();break;
                    case "view": TabViewMenu(); break;
                    case "edit_meal" : TabEditMeal(); break;
                    case "view_meal" : TabViewMeal(); break;
                    case "new" :  TabNewMenu(); break;
                    case "new_meal" : TabNewMeal(); break;
                    case "copy" : TabCopyMenu(); break;
                    case "copy_meal" : TabCopyMeal(); break;
                }

                if (Request.QueryString["print"] == "true")
                {
                    menusloadingscript.Text = "<script> $(document).ready(function () { PrintMenuPage() } );</script>";
                }

            }
        }

        protected void TabNewMeal()
        {
            TabMyMealsOn();
            pMyMeals.Visible = true;
            ...
            mealIntroduction.Visible = true;
            mealIntroduction.InnerHtml = "<h2>Step 1 : Please name the meal</h2>";
            ...
            mealNameDiv.InnerHtml =
                ...
                "<img src=\"/images/icons/web/save.png\" width=\"20\" style=\"margin-left: 10px; margin-top: 12px;\" class=\"editicons\"  onclick=\"editMealNameBackLabel($('#mealName').val().replace('&','%26'));\" alt=\"Save Image\" title=\"Save Meal Name\"/>";

            servespan.InnerHtml = "<input type=\"number\" id=\"serveSpanTextBox\" style=\"width:50px;\" onblur=\"meal_editServe($('#serveSpanTextBox').val());\"></input>";
            iconEditServe.Src = "/images/icons/web/save.png";
            iconEditServe.Attributes["onclick"] = "meal_editServe($('#serveSpanTextBox').val())";

            mealDescription.InnerHtml =
                "<textarea id=\"mealDescriptionTextArea\" onKeyDown=\"limitText(this.form.mealDescriptionTextArea,this.form.countdown,250);\" onKeyUp=\"limitText(this.form.mealDescriptionTextArea,this.form.countdown,250);\" " +
                "onblur=\"meal_editDescription($('#mealDescriptionTextArea').val())\" placeholder=\"Optional\">" +
                "</textarea><br><font size=\"1\">You have <input readonly type=\"text\" name=\"countdown\" size=\"3\" value=\"250\"> characters left.</font>";
            iconEditDesc.Src = "/images/icons/web/save.png";
            iconEditDesc.Attributes["onclick"] = "meal_editDescription($('#mealDescriptionTextArea').val())";
            mealDescription.Style["line-height"] ="8px";
        ...
        protected void TabCopyMeal()
        {
            ...
            _meal.iPortion = _meals.First().iPortion ?? 1;
        ...
        private string GetMenuName(int menuId)
        {
            ...
            foreach (Menu menu in _menus)
            {
                ...
                literalMenuAddToDiary.Text = "<div id=\"lnkAddToDiary\" onclick=\"openMealMenuDialog('menu_" + menuId + "'); return false;\"><div><img src=\"/images/icons/web/addtofooddiary.png\" alt=\"Add to Food Diary\"/></div><div>Add to Diary</div></div>";

                literalAddMenuToMyDiarySelect.Text = "<div id=\"menu_" + menuId + "\" class=\"one_of\" style=\"display: none;\" >";
                literalAddMenuToMyDiarySelect.Text += "<div style=\"height:27px;display:block;float:left;line-height:27px;margin-right:5px;\">Copy this daily plan on </div>";
                literalAddMenuToMyDiarySelect.Text += CopyToDates(menuId);
                literalAddMenuToMyDiarySelect.Text += "</div>";

                ShareDivOnclickDefinerMenu(menuId);

                if(Request.QueryString["tab"].Equals("edit"))
                {
                    if(!menu.ImageUrl.Equals("menu_generic.jpg"))
                    {
                        menuImage.Src = "/images/menus/" + menu.ImageUrl;
                    }
                }
                else //tab view
                {
                    literalCopyToMyMenu.Text = "<div onclick=\"window.open('/club-vision/my-eating/menus/?tab=copy&menuId=" + menuId + "','_self')\">" +
                                            "<div><img src=\"/images/icons/web/savetomyaccount.png\" alt=\"Copy to My Account\"/></div>" +
                                            "<div>Copy to My Account</div></div>";
                    menuAddPictureDiv.Visible = false;
                    menuImageUploadDiv.Visible = false;
                    menu_shareToHQ.Visible = false;

                    if(Session["Trainer"].Equals("No"))
                    {
                        menu_shareToTrainerOrClient.Visible = false;
                    }
                }
        ...
        {
            menuNameDiv.InnerHtml = GetMenuName(menuId);
            ...
            MenuTotSpanCho.InnerText = carbohydrate.ToString("0.00");
            MenuTotSpanPtn.InnerText = protein.ToString("0.00");
            MenuTotSpanFat.InnerText = fat.ToString("0.00");
        ...
        {
            menuNameDiv.InnerHtml = GetMenuName(menuId) +"<img src=\"/images/icons/web/edit-red.png\" onclick=\"editMenuName('" + GetMenuName(menuId) + "'); return false;\" style=\"margin-left:10px;height:21px;\" class=\"editicons\" alt=\"edit name\" title=\"Edit Daily Plan Name\"/>"; ;
        ...
        private void UpdateViewMeal(int mealId)
        {
            ...
            int mealServe = (int)_meals.First().iPortion;

            mealNameDiv.InnerHtml = _meals.First().Name;
            mealImg.Src = "/images/meals/" + _meals.First().ImageUrl;
            servespan.InnerText = mealServe + "";

            if (_meals.First().cDescription == null)
            {
                mealDescription.InnerHtml = "<p style=\"font-style: italic;\">Healthy Vision Meal</p>";
            }
            else
            {
                mealDescription.InnerHtml = "<p>" + _meals.First().cDescription + "</p>";
            }

            ShareDivOnclickDefiner(mealId);
            shareToHQ.Visible = false;
            shareMealPlan_Select.Style["height"] = "112px";

            if ((string)Session["MemberType"] == "VVT")
            {
                shareMealPlan_Select.Style["height"] = "80px";
            ...
            else
            {
                ...
                lnkAddPicture.Visible = false;
                lnkUL.Visible = false;
                lnkDL.Style["border-left"] = "none";
                saveMealToMyAcc.Text = "<div onclick=\"window.open('/club-vision/my-eating/menus/?tab=copy_meal&mealId=" + mealId + "','_self')\">" +
                                       "<div><img src=\"/images/icons/web/savetomyaccount.png\" alt=\"Copy to My Account\"/></div>" +
                                       "<div>Copy to My Meals</div></div>";
            }
            ...
            if (_meals.First().VideoId == null)
            {
                ...
                {
                    lnkDL.Attributes["onclick"] = "window.open('/club-vision/recipe/" + _meals.First().PDFAddress +
                                                  "','_blank');";
                    lnkDL.Visible = true;
                }
            }
            else
            {
                ...
                lnkTV.Attributes["onclick"] = "window.open('/club-vision/education/vision-tv?vid=" + _meals.First().VideoId+ "','_blank');";
                //lnkTV.InnerText = " TV ";
                ...
                if (video != null)
                {
                    if (video.LinkURL != "")
                    {
                        lnkDL.Attributes["onclick"] = "window.open('" + video.LinkURL + "','_blank');";
                        lnkDL.Visible = true;
                    }
                    lnkTV.Visible = true;
            ...
            SpanCHOPortion.InnerText = (carbohydrate/mealServe).ToString("0.00");
            SpanPTNPortion.InnerText = (protein / mealServe).ToString("0.00");
            SpanFATPortion.InnerText = (fat / mealServe).ToString("0.00");
             ...
             */
            mealAddToDiary.Text += "<div id=\"lnkAddToDiary\" onclick=\"openMealMenuDialog('meal_" + _meals.First().Id + "'); return false;\"><div><img src=\"/images/icons/web/addtofooddiary.png\" alt=\"Add to Food Diary\"/></div><div>Add to Diary</div></div>";
            
            literalMealAddToDiaryDiv.Text = "<div id=\"meal_" + _meals.First().Id + "\" class=\"one_of\" style=\"display: none;\" >";
            literalMealAddToDiaryDiv.Text += "<div style=\"height:27px;display:block;float:left;line-height:27px;margin-right:5px;\">Copy this meals as <select  id=\"meal_" + _meals.First().Id + "_time\"><option value=\"1\">Breakfast</option><option value=\"2\">Morning Tea</option><option value=\"3\">Lunch</option><option value=\"4\">Afternoon Tea</option><option value=\"5\">Dinner</option><option value=\"6\">Supper</option></select> on </div>";
            literalMealAddToDiaryDiv.Text += CopyToDates_Meal(_meals.First().Id);
            literalMealAddToDiaryDiv.Text += "</div>";
        ...
        private void UpdateEditMeal(int mealId)
        {
            ...
            {
                mealNameDiv.InnerHtml = _meals.First().Name + "<img src=\"/images/icons/web/edit-red.png\" onclick=\"editMealName('" + _meals.First().Name + "'); return false;\" style=\"margin-left:10px;height:21px;\" class=\"editicons\" alt=\"edit name\" title=\"Edit Meal Name\"/>";
                ...
                if(_meals.First().cDescription == null)
                {
                    mealDescription.InnerHtml = "<p style=\"font-style: italic;\">Please enter the description</p>";
                }
                else
                {
                    mealDescription.InnerHtml = "<p>" + _meals.First().cDescription + "</p>";
                ...
                iconEditDesc.Visible = true;
                iconEditServe.Visible = true;
                shareMealPlan_Select.Style["left"] = "742px";
                ...
                mealImg.Src = _meals.First().ImageUrl.Equals("meal_generic.jpg") ? "/images/meals/meal_generic.jpg":
                                                                                    "/images/meals/" + _meals.First().ImageUrl;
                panel_admin.Visible = (string)Session["Admin"] == "Yes";
                lnkEditPortion.Visible = (string)Session["Admin"] == "Yes";
                ...
                if (_meals.First().PDFAddress != null)
                {
                    lnkDL.Attributes["onclick"] = "hide_one_of();window.open('/club-vision/recipe/" + _meals.First().PDFAddress + "','_blank')";
                }
                else
                {
                    lnkDL.Visible = false;
                ...
                if (_meals.First().VideoId != null)
                {
                    videoId.Value = _meals.First().VideoId.ToString();
                    lnkTV.Attributes["onclick"] = "window.open('/club-vision/education/vision-tv?vid=" + _meals.First().VideoId + "','_blank');";
                    lnkDL.Attributes["display"] = "block";
                ...
                */
                mealAddToDiary.Text += "<div id=\"lnkAddToDiary\" onclick=\"openMealMenuDialog('meal_" + _meals.First().Id + "', this.id); return false;\"><div><img src=\"/images/icons/web/addtofooddiary.png\" alt=\"Add to Food Diary\"/></div><div>Add to Diary</div></div>";
        ...
        {
            shareToFB.Attributes["onclick"] = "openMealMenuDialog('shareMealPlan_Select', this.id);ShareMenuOrMeal(3,-1," + mealid + ",'facebook'); return  false;";
            shareToTwitter.Attributes["onclick"] = "openMealMenuDialog('shareMealPlan_Select', this.id);ShareMenuOrMeal(3,-1," + mealid + ",'twitter'); return  false;";
            shareToHQ.Attributes["onclick"] = "openMealMenuDialog('shareMealPlan_Select', this.id);ShareMenuOrMeal(3,-1," + mealid + ",'VVTHQ'); return  false;";
            shareToEmail.Attributes["onclick"] = "openMealMenuDialog('shareMealPlan_Select', this.id);enterEmailToShare(\"ShareMenuOrMeal(3,-1," + mealid + ",'email')\"); return  false;";

            if (Session["Trainer"].Equals("No"))
            {
                //from client to trainer
                shareToTrainerOrClient.Attributes["onclick"] = "openMealMenuDialog('shareMealPlan_Select', this.id);ShareMenuOrMeal(3,-1," + mealid + ",'trainer'); return  false;";
            }
            else
            {
                //from trainer to client
                shareToTrainerOrClient.Attributes["onclick"] = "openMealMenuDialog('shareMealPlan_Select', this.id);ShareMenuOrMeal(3,-1," + mealid + ",'clients'); return  false;";
                shareToTrainerOrClient.InnerHtml = "<img src='/images/trainer.small.icon.jpg'/>&nbsp;&nbsp;&nbsp;My Clients";
            }

        }

        private void ShareDivOnclickDefinerMenu(int menuid)
        {
            menu_shareToFB.Attributes["onclick"] = "openMealMenuDialog('shareDailyPlan_Select', this.id);ShareMenuOrMeal(2," + menuid + ",-1,'facebook'); return  false;";
            menu_shareToTwitter.Attributes["onclick"] = "openMealMenuDialog('shareDailyPlan_Select', this.id);ShareMenuOrMeal(2," + menuid + ",-1,'twitter'); return  false;";
            menu_shareToHQ.Attributes["onclick"] = "openMealMenuDialog('shareDailyPlan_Select', this.id);ShareMenuOrMeal(2," + menuid + ",-1,'VVTHQ'); return  false;";
            menu_shareToEmail.Attributes["onclick"] = "openMealMenuDialog('shareDailyPlan_Select', this.id);enterEmailToShare(\"ShareMenuOrMeal(2," + menuid + ",-1,'email')\"); return  false;";

            if (Session["Trainer"].Equals("No"))
            {
                //from client to trainer
                menu_shareToTrainerOrClient.Attributes["onclick"] = "openMealMenuDialog('shareDailyPlan_Select', this.id);ShareMenuOrMeal(2," + menuid + ",-1,'trainer'); return  false;";
            }
            else
            {
                //from trainer to client
                menu_shareToTrainerOrClient.Attributes["onclick"] = "openMealMenuDialog('shareDailyPlan_Select', this.id);ShareMenuOrMeal(2," + menuid + ", -1,'clients'); return  false;";
                menu_shareToTrainerOrClient.InnerHtml = "<img src='/images/trainer.small.icon.jpg'/>&nbsp;&nbsp;&nbsp;My Clients";
            }
        }
        ...
        private string ServeUnit(MealItem mealItem)
        {
            ...
            if (mealItem.FromItemsAdd == true)
            {
                ...
                var items = (from item in cvdc.ItemAdds
                             where item.Name == mealItem.ItemAdd.Name
                ...
                if (items.Count() > 1)
                {
                    ...
                    {
                        returnValue += "<option ";
                        if (item.Id == mealItem.ItemAdd.Id)
                        {
        ...
        private string ServeUnit(MenuItem menuItem, int mealTimeId)
        {
            ...
            if (menuItem.FromItemsAdd == true)
            {
                ...
                var items = (from item in cvdc.ItemAdds
                             where item.Name == menuItem.ItemAdd.Name
                             where item.CustomerId == (int)Session["MemberNo"]
                             //where item.ItemCategories.First().CategoryId == mealItem.Item.ItemCategories.First().CategoryId
                             select item);
        ...
        protected void UploadMenuImage(object sender, EventArgs e)
        {
            try
            {
                if (MenuImgFileUpload.HasFile)
                {
                    if ((MenuImgFileUpload.PostedFile.ContentType.Equals("image/jpeg") ||
                        MenuImgFileUpload.PostedFile.ContentType.Equals("image/jpg") ||
                        MenuImgFileUpload.PostedFile.ContentType.Equals("image/png") ||
                        MenuImgFileUpload.PostedFile.ContentType.Equals("image/gif")) &&
                        MenuImgFileUpload.PostedFile.ContentLength < 5243000)
                    {
                        string fileName = currentMenuId.Value + Path.GetExtension(MenuImgFileUpload.FileName);

                        ClubVisionDataContext cvdc = new ClubVisionDataContext();

                        var menu = (from mn in cvdc.Menus
                                    where mn.Id == Convert.ToInt32(currentMenuId.Value)
                                    select mn).SingleOrDefault();

                        if (menu != null && (SaveImgAndResize(fileName, true)))
                        {
                            menu.ImageUrl = "customer_menus/" + Session["MemberNo"] + "/" + currentMenuId.Value + Path.GetExtension(MenuImgFileUpload.FileName);

                            cvdc.SubmitChanges();

                            Response.Redirect("/club-vision/my-eating/menus/?tab=edit&menuId=" + currentMenuId.Value);
                        }
                        else
                        {
                            Response.Redirect("/club-vision/my-eating/menus/?tab=edit&menuId=" + currentMenuId.Value + "&msg=photofailednull");
                        }
                    }
                    else
                    {
                        Response.Redirect("/club-vision/my-eating/menus/?tab=edit&menuId=" + currentMenuId.Value + "&msg=photofailed");
                    }
            ...
            try
            {
                if (mealImageFileUpload.HasFile)
                {
                        ...
                        mealImageFileUpload.PostedFile.ContentLength < 5243000)
                    {
                        ...
                        if (meal != null && (SaveImgAndResize(fileName, false)
                            && CheckUploadEligibility((int)meal.CustomerId, (int)Session["MemberNo"])))
                        {
                            ...
                            Response.Redirect("/club-vision/my-eating/menus/?tab=edit_meal&mealId=" + currentMealId.Value);
                        }
                        else
                        {
                            Response.Redirect("/club-vision/my-eating/menus/?tab=edit_meal&mealId=" + currentMealId.Value + "&msg=photofailed");
                        }
                    }
                    else
                    {
                        Response.Redirect("/club-vision/my-eating/menus/?tab=edit_meal&mealId=" + "&msg=photofailed");
                    }
            ...
            try
            {
                if (mealRecipeFileUpload.HasFile)
                {
                    if ((mealRecipeFileUpload.PostedFile.ContentType.Equals("application/pdf") ||
                        ...
                        mealRecipeFileUpload.PostedFile.ContentLength < 512000)
                    {
                        ...
                        {
                            Response.Redirect("/club-vision/my-eating/menus/?tab=edit_meal&mealId=" + currentMealId.Value + "&msg=recipefailed");
                        }
                    }
                    else
                    {
        ...
        protected bool SaveImgAndResize(string filename, bool isMenu)
        {
            try
            {
                // Find the fileUpload control
                ...
                // Find the fileUpload control
                string path = isMenu ? "/images/menus/customer_menus/" + Session["MemberNo"] + "/" : 
                                        "/images/meals/customer_meals/" + Session["MemberNo"] + "/";
                ...
                Bitmap originalBMP = isMenu ? new Bitmap(MenuImgFileUpload.FileContent) : 
                                                new Bitmap(mealImageFileUpload.FileContent);
        ...
        protected void TabVisionMealsOn()
        {
            tabVisionMeals.Style["border-bottom"] = "none";
            tabVisionMeals.Style["color"] = "#C60C30";
            tabVisionMeals.Style["background"] = "-webkit-linear-gradient(top, #ededed 0, #f7f7f7 50%, #fff 100%)";
        }

        protected void TabMyMealsOn()
        {
            tabMyMeals.Style["border-bottom"] = "none";
            tabMyMeals.Style["color"] = "#C60C30";
            tabMyMeals.Style["background"] = "-webkit-linear-gradient(top, #ededed 0, #f7f7f7 50%, #fff 100%)";
        }

        protected void TabMyMenusOn()
        {
            tabMyMenus.Style["border-bottom"] = "none";
            tabMyMenus.Style["color"] = "#C60C30";
            tabMyMenus.Style["background"] = "-webkit-linear-gradient(top, #ededed 0, #f7f7f7 50%, #fff 100%)";
        }

        protected void TabVisionMenusOn()
        {
            tabVisionMenus.Style["border-bottom"] = "none";
            tabVisionMenus.Style["color"] = "#C60C30";
            tabVisionMenus.Style["background"] = "-webkit-linear-gradient(top, #ededed 0, #f7f7f7 50%, #fff 100%)";
        }
