<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WeightsSessionsHistory.ascx.cs" Inherits="VisionPersonalTrainingProject.usercontrols.VVT.WeightsSessionsHistory" %>
<style type="text/css">
    img {
        cursor: hand;
        cursor: pointer;
...
<div class="pTrainingDiary" id="weightSessDiv" style="margin-right: 10px !important;padding:10px;" runat="server" ClientIDMode="Static">
    ...
    <div id="WeightsSessHistory">
        ...
        <asp:Literal id="litWeightsHistory" runat="server"></asp:Literal>
...
<div id="wsNotAVailable" clientidmode="Static" runat="server" Visible="False">
     <h2>You don't have any Weights Sessions history to display</h2>
</div>
