<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Registration.ascx.cs" Inherits="VisionPersonalTrainingProject.usercontrols.VVT.Registration" %>
...
<div style="float: left; width: 450px;" >
    <asp:UpdatePanel ID="upMessage" runat="Server" UpdateMode="Conditional">
        ...
        <asp:DropDownList ID="DropDownList1" runat="server" Width="347" 
            ...
            <asp:ListItem Value="12">Living Social</asp:ListItem> 
