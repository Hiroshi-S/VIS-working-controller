<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MyGoals.ascx.cs" Inherits="VisionPersonalTrainingProject.usercontrols.VVT.VVT_Initial_Steps.MyGoals" %>
    ...
    <div class="mygoal"  style="margin-right: 10px !important;">
        <div style="float: left;display: block;margin-bottom: 30px;" id="goalHeaderButton" runat="server">
            ...
            <div style="float: left;display: block" >
                <div style="display: block;float: left;width: 883px;height: 30px;">
                    <div style="float: left;">
                        <h2>Weight Loss Goal : <asp:Label ID="GoalDateLabel" runat="server" Text="Label"></asp:Label></h2>
                    </div>
                </div>
                <div id="myGoalHeader1" runat="server" style="float: left;display: block">
                    <asp:Button ID="PreviousGoalButton" runat="server" Text="<< Previous" CssClass="button-small vision_red_reverse rounded3" onclick="PreviousGoalButton_Click" />
                </div>
                <div id="myGoalHeaderNext" runat="server" style="float:left;display:block;">
                    <asp:Button ID="NextGoalButton" runat="server" Text="Next >>" CssClass="button-small vision_red_reverse rounded3" onclick="NextGoalButton_Click" />
                </div>
                <div id="myGoalHeader2" runat="server" style="float: left;display: block;">
                    <asp:Button ID="CreateNewGoalButton" runat="server" Text="Create New" CssClass="button-small vision_red rounded3" onclick="CreateNewGoalButton_Click"  Visible="False"/>
        ...
        <span style="display: none;"><asp:Label ID="bodytypeLabel" runat="server" Text="Label"></asp:Label></span>    
        <br/>
        ...
        <asp:ValidationSummary ID="myGoalValidationSummary" ForeColor="red" runat="server" ValidationGroup="mygoal" />
            ...
            <ContentTemplate>
                <table style="width: 583px;">
                    <colgroup>
                        ...
                        <tr id="trImperial" runat="server" style="display: none;">
                            ...
                            <td>
                                <asp:DropDownList ID="weightGoalDropDownListImperial" runat="server" Width="82"
                            ...
                            <td>
                                <asp:RequiredFieldValidator ID="imperialddlRequiredFieldValidator" Enabled="False"
                                    runat="server" ControlToValidate="weightGoalDropDownListImperial" ErrorMessage="" SetFocusOnError="True"
                        ...
                        <tr id="trMetric" runat="server" style="display: none;">
                            ...
                            <td>
                                <asp:RequiredFieldValidator ID="metricddlRequiredFieldValidator"  Enabled="False" SetFocusOnError="True"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RequiredFieldValidator ID="activityLvlDropDownListRequiredFieldValidator" SetFocusOnError="True"
                ...
                <div id="RecommendationDiv" runat="server" style="display: none;">
                    ...
                    <br/>
                       ...
                       <img src="/images/cardioicon.jpg" style="display: inline-block;margin-right: 15px;vertical-align: sub"/><h3 style="display: inline-block;">Cardio</h3>
                      <p>  Cardio exercise is given two classifications – Low to Moderate or Hard. <br/>
                        ...
                        <br /></p>
                        <!--<a href="javascript:lmcardio();" class="button-small vision_navy rounded3">Click here to see a video about L-M/Hard cardio</a>-->
                        
                        <div style="height: 60px;width: 100%;display: block;float: left;cursor: hand; cursor: pointer;" onclick="lmcardio();">
                            ...
                            <div style="float: left;display: block; margin-top: -5px;">
                              <div class="button-small vision_navy rounded3">>> Learn About L-M / Hard Cardio <<</div> 
                            </div> 
                        </div>
                        ...
                        <img src="/images/barbel.jpg" style="display: inline-block;margin-right: 15px;vertical-align: sub"/><h3 style="display: inline-block;">Weights</h3>
                         <p>Weights session include working out with barbells, dumbbells, resistance 
        ...
        <div style="width: auto; height: 50px;display: none;"  class="realButtonDiv">
            ...
            <div style="float: right">
                <asp:imagebutton ID="MyGoalImagebuttonNext" ImageUrl="/images/buttonSaveAndNext.gif" 
                    runat="server" ValidationGroup="mygoal" ClientIDMode="Static"
                    onclick="MyGoalImagebuttonNextClick"></asp:imagebutton>
                <asp:imagebutton ID="MyGoalImagebuttonNextUC" ImageUrl="/images/buttonSaveAndNext.gif"  ValidationGroup="mygoal"
        ...
        <div class="istepsDiv">
            <div class="istepsWrapper">
                <div style="border-left: none;" onclick="window.open('/club-vision/account-setup/measurements/', '_self');">
                ...
                <div id="nextDiv" onclick="$('#MyGoalImagebuttonNext').click();return false;">
