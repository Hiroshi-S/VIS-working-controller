...
{
    public partial class PersonalProfile : System.Web.UI.UserControl
    {
        ...
        protected void Imagebutton1_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            try
            {
                ...
                Response.Redirect(customer.bCompleteInitialState == false ? "/club-vision/account-setup/life-style-screen/" : "/club-vision/account-setup/personal-profile/", false);
            }
            catch (Exception ex)
            {
                ErrorPopup();
        ...
        protected void ErrorPopup()
        {
            const string s = "<script type=\"text/javascript\">" +
                                 "document.getElementById('title').innerHTML = \"Please Note\";" +
