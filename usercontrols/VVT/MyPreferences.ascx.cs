        ...
        protected string GenerateHTML()
        {
            ...
            foreach (Preference preference in nutritionPref)
            {
                ...
                if(preference.isBitValue == false && isVPTOnly)//currently it returns only food diary pref value
                {
                    ...
                    {
                        if (singleOrDefault.PrefItemId != null && singleOrDefault.PrefItemId != 1)
                        {
                            nutpref += "<script>$(\"#foodDiaryPref\").val(\"" + singleOrDefault.PrefItemId + "\");</script>";
                        }
                    }
                ...
                else
                {
                    ...
                    nutpref +=  "<td><div class=\"Switch " + onoff + "\" data-type=\"" + preference.Type + "\"" +
