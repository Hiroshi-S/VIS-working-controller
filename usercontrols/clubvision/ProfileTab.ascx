<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProfileTab.ascx.cs" Inherits="VisionPersonalTrainingProject.usercontrols.clubvision.ProfileTab" %>
...
<div id="eProfileTab" class="element" style="overflow: visible"><!-- 605 -->
    <div class="replace" id="profileTab" runat="server">              
    ...
    <div class="clear"></div>
    <div class="eContent eOrange" id="eProfileTabGoal" runat="server">
    ...
    <div class="eContent eOrange" id="eProfileTabTrain" style="display: none;" runat="server">
            ...
            <div id="tableTrainingDiaryProfilediv">
            ...
            <div style="float: right;padding-right: 20px;">	 	
	                <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/images/buttonEditTraining.gif" OnClick="ImageButton1_Click" />	 	
            </div>
    ...
    <div class="eContent eOrange" id="eProfileTabMenu" style="display: none;" runat="server">
...
<div style="display:block;" id="DivReadySetGoQ" class="element"><!-- 605 -->
  <h3 class="replace" style="background: url('/images/eHdrReadySetGoQ.gif') no-repeat scroll 0 0 transparent;">Ready Set Go Questionnaire</h3>
  <div class="eContent eOrange"> 
        ...
        <%--to take the questionnaires that are outlined in "Ready Go Set - 3 Steps to Better Health" written by Vision Founder Andrew Simmons.<br/><br/>
        These questionnaires will assist you in identifying areas that may influence your results. Good luck!--%>
    <div class="clear">&nbsp;</div>
  </div><!-- /eContent -->
  <div class="clear">&nbsp;</div>
</div><!-- /eDailyMenus -->
