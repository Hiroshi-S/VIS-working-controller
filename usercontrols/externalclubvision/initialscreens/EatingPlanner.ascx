<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EatingPlanner.ascx.cs" Inherits="VisionPersonalTrainingProject.usercontrols.externalclubvision.initialscreens.EatingPlanner" %>


 <div class="eatingplan" style="margin-right: 10px !important;">
        <span id="eatingPlanTitle" style="color: #E27423;"><h2>STEP 7</h2></span><br/>
                    
        <h3>Eating Recommendation</h3><br/>
        ...
        <div id="gotofooddiaryDiv" onclick="window.open('/club-vision/my-eating/food-diary/','_self')" style="height: 39px;width: 147px;display: block;float: left;cursor: hand; cursor: pointer;-moz-border-radius: 0px 0px 0px 5px;
        border-radius: 3px; background-color: #999999;color: white; margin-left: 294px;text-align: center;padding-top: 8px;margin-top: -58px;">
                Click here to create your eating plan now
                
        </div>
                    
        <br/><br/>
        <div id="eatingExplanation">
        <h3>Why you have been given nutrition macros and what do they mean?</h3>
        ...
        <br />
            <br />
        <h3>So let's find out more about each macronutrient:</h3>
       ...
       <div style="width: auto; height: 50px " id="EatingPlannerButtonsDiv">
